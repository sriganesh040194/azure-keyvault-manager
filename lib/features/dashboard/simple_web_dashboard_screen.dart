...
class SimpleWebDashboardScreen extends StatefulWidget {
  final SimpleWebAuthService authService;

  const SimpleWebDashboardScreen({
    super.key,
    required this.authService,
  });

  @override State<SimpleWebDashboardScreen> createState() => _SimpleWebDashboardScreenState();
}

class _SimpleWebDashboardScreenState extends State<SimpleWebDashboardScreen> {
